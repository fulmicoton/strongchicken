# -*- coding: utf-8 -*-
#
# strongchicken documentation build configuration file, created by
# sphinx-quickstart on Sat Dec 25 14:06:40 2010.
#
...
project = u'strongchicken'
copyright = u'2010, Paul Masurel'
...
htmlhelp_basename = 'strongchickendoc'
...
latex_documents = [
  ('index', 'strongchicken.tex', u'strongchicken Documentation',
   u'Paul Masurel', 'manual'),
]
...
man_pages = [
    ('index', 'strongchicken', u'strongchicken Documentation',
     [u'Paul Masurel'], 1)
]
...
epub_title = u'strongchicken'
epub_author = u'Paul Masurel'
epub_publisher = u'Paul Masurel'
epub_copyright = u'2010, Paul Masurel'
